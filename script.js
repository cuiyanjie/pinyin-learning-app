...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showPracticeCards() {
        ...
        practiceGrid.className = 'practice-grid'; // 新增九宫格样式类
        practiceContainer.appendChild(practiceGrid);

        // 创建“换一批”按钮
        const refreshButton = document.createElement('button');
        refreshButton.textContent = '换一批';
        refreshButton.className = 'refresh-btn'; // 使用新样式类
        refreshButton.addEventListener('click', displayNineCards); // 点击按钮重新加载九宫格
        practiceContainer.appendChild(refreshButton);
